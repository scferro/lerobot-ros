from lerobot import teleoperate as lto
...
orig_make_robot_from_config = lto.make_robot_from_config
orig_make_teleoperator_from_config = lto.make_teleoperator_from_config
...
# Replace the default robot creation function with our ROS2-specific one
lto.make_robot_from_config = make_my_robot_from_config
lto.make_teleoperator_from_config = make_my_teleoperator_from_config
